...
const navItems = {
  loggedOut: [
    ...
    { href: "../shop.html", text: "Cửa hàng" },
    { href: "../about.html", text: "Giới thiệu" },
    { href: "../sitemap.html", text: "Sitemap" },
    { href: "../sign-in.html", text: "Đăng nhập" },
    { href: "../sign-up.html", text: "Đăng ký" },
  ],
  loggedIn: [
    { href: "../index.html", text: "Trang chủ" },
    { href: "../shop.html", text: "Cửa hàng" },
    { href: "../about.html", text: "Giới thiệu" },
    { href: "../sitemap.html", text: "Sitemap" },
    { href: "../cart.html", text: "Giỏ hàng", id: "cart-link" },
    {
      href: "#",
      text: "Chào, {username}",
      class: "welcome-message dropdown",
      dropdown: [
        { href: "../me.html", text: "Trang cá nhân" },
